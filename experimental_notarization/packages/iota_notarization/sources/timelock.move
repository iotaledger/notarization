...
module iota_notarization::timelock {
    ...
    public fun new_unix_lock_time(unix_time: u32, clock: &Clock): TimeLock {
    ...
    public fun new_unix_time_span(unix_time: u32, unix_time_span: u32, clock: &Clock): TimeLock {
        let now = (clock::timestamp_ms(clock) / 1000) as u32;
        ...
        TimeLock::UnixTimeSpan(unix_time, unix_time_span)
    }
