...
The folder [poi](./poi) contains examples for IOTA Proof of Inclusion. See there to learn how to construct portable proofs and verify them against an independently trusted network anchor.
